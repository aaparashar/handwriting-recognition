...
NeuralNetwork::NeuralNetwork(unsigned int inputNodes, float learningRate, std::unique_ptr<CostFunctionStrategy> costFunction) : inputNodes_(inputNodes),
...
NeuralNetwork *NeuralNetwork::load(const char *filename)
{
    ...
    {
        costFunction = new MeanSquareErrorCost();
    }
